...
public class VaultTecNetworkServerMain implements WindowListener{
    ...
    private final JLabel newNewsDialogHeadlineTitle = new JLabel("Nag��wek");
    ...
    public void startGUI()
    {
        ...
        newNewsDialogAccept.addActionListener(e -> {
                newNewsDialog.dispose();
                numberOfNews++;
                news.put(numberOfNews, new News(numberOfNews, newNewsDialogHeadline.getText(), newNewsDialogMessage.getText()));
        ...
        checkIPButton.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                {
                    checkIP = false;
                    checkIPButton.setText("Błąd połączenia!");
                }
                finally
                {
                    if (readerIP != null)
	...
	public void serverStart()
	{
		...
		try {
			...
			while (true)
			{
				...
				message("Serwer", "Żądanie od klienta ...");
